...
accidents0514 <- fread("data/dftRoadSafety_Accidents_2016.csv", header = TRUE, sep = ",")
accidents0514 <- accidents0514 %>%
select(Accident_Severity, Date)
accidents15 <- fread("data/dftRoadSafety_Accidents_2017.csv", header = TRUE, sep = ",")
...
## Road accidents in GB (2005-2017)
